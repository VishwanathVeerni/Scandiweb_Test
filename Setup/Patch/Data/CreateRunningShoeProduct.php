 ...
 */
class CreateRunningShoeProduct implements DataPatchInterface
{
    /**
    ...
    public function execute(): void
    {
        ...
        if ($product->getIdBySku('running-shoe')) {
            return;
        }
        ...
        //Adding Category using Category Collection
        $categoryTitles = ['Men'];
